...
////////////////////////////////////////////////////////////////////
//      My Code Below    |  Hubspot code above: https://github.com/osugraytr/oauth-quickstart-nodejs
////////////////////////////////////////////////////////////////////
var PORT = 3000;
...
async function OAuth_HubSpot(SessionID) {
    console.log("\n Trying to OAUTH:\t0 \n");
    return "Worked"
    var HubSpotInformation = {}
    if (await isAuthorized(SessionID)) {
        console.log("\n Trying to OAUTH:\t1 \n");
        HubSpotInformation.accessToken = await getAccessToken(req.sessionID);
        HubSpotInformation.contact = await getContact(accessToken);
        return HubSpotInformation
    } else {
        console.log("\n Trying to OAUTH:\t2 \n");
        HubSpotInformation.not_authorized = "Not_Authorized";
        return HubSpotInformation
    }
}
